...
<body>
<h1><center> Your cart has,</center></h1>
<%
String Product_type=request.getParameter("hd");
int Rate=Integer.parseInt(request.getParameter("pri"));
int Quantity=Integer.parseInt(request.getParameter("qty"));
out.println("Product: "+Product_type+"<br>");
out.println("Rate: "+Rate+"<br>");
out.println("Quantity: "+Quantity+"<br>");
int total=Rate*Quantity;
out.println("<hr width='200px' align='left'>");
out.println("Total Amount is "+total);
%>
